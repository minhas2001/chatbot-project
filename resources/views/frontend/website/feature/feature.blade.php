...
<section class="features-wrap-layout1" id="doctor">
                    ...
                    <div class="row justify-content-end">
                        <div class="col-lg-6 col-sm-12 col-12">
                            <div class="item-content-inner inner-title-dark">
                                <h2 class="item-title">We make things simple
                                </h2>
                                <p>CareWave Health makes complex healthcare processes simple: triage, scheduling, and
                                    chronic care in one secure solution.
                                ...
                                <div class="skill-layout1">
                                    <div class="progress">
                                        ...
                                        <div
                                            style="width: 80%; visibility: visible; animation-duration: 1.5s; animation-delay: 0.4s;"
                                            data-progress="95%"
                                    ...
                                    <div class="progress">
                                        ...
                                        <div
                                            style="width: 75%; visibility: visible; animation-duration: 1.5s; animation-delay: 0.8s;"
                                            data-progress="99%"
                                            class="progress-bar progress-bar-striped wow fadeInLeft animated">
                                            <span>75%</span>
                                        </div>
