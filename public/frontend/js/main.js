!function (e) {
    ...
    function o() {
        var a = e(".header-height-wrap"), t = e(window).width(), n = a.parents("#wrapper").find("#header-area-space"),
            o = a.outerHeight();
    ...
    t.length && t.datetimepicker({
        ...
        if (location.pathname.replace(/^\//, "") == this.pathname.replace(/^\//, "") && location.hostname == this.hostname) {
            var a = e(this.hash);
            if (a.length > 0) return a = a.length ? a : e("[name=" + this.hash.slice(1) + "]"), e("html,body").animate({scrollTop: a.offset().top}, 1e3), !1
        }
        ...
        a.preventDefault();
        var t = e(this), n = parseInt(t.parent(".loadmore").data("count"), 10) || 1,
            o = t.parents(".menu-list-wrapper").find(".menu-list").find(".menu-item.hidden").slice(0, n);
        return o.length ? (o.animate({opacity: 0}), o.promise().done(function () {
    ...
    if (i) {
        ...
        var s = document.getElementById("price-range-min"), r = document.getElementById("price-range-max");
    ...
    if (c.length && c.validator().on("submit", function (a) {
        var t = e(this), n = c.find(".form-response");
        if (!a.isDefaultPrevented()) return e.ajax({
            ...
            success   : function (e) {
                var a = JSON.parse(e);
                if (console.log(a), a.success) t[0].reset(), n.html("<div class='alert alert-success'><p>Message has been sent successfully.</p></div>"); else if (a.message.length) {
                    var o = null;
        ...
        dropdownAutoWidth: !0,
        width            : "100%"
    }), e(".parallaxie").length && e(".parallaxie").parallaxie({speed: .5, offset: 0}), e("#googleMap").length) {
    ...
    e(".rc-carousel").each(function () {
        var a = e(this), t = a.data("loop"), n = a.data("items"), o = a.data("margin"),
            i = (a.data("stage-padding"), a.data("autoplay")), s = a.data("autoplay-timeout"),
            r = a.data("smart-speed"), l = a.data("dots"), d = a.data("nav"), c = a.data("nav-speed"),
            p = a.data("r-x-small"), u = a.data("r-x-small-nav"), h = a.data("r-x-small-dots"),
            m = a.data("r-x-medium"), g = a.data("r-x-medium-nav"), v = a.data("r-x-medium-dots"),
            f = a.data("r-small"), w = a.data("r-small-nav"), y = a.data("r-small-dots"), k = a.data("r-medium"),
            b = a.data("r-medium-nav"), x = a.data("r-medium-dots"), S = a.data("r-large"), T = a.data("r-large-nav"),
            C = a.data("r-large-dots"), q = a.data("r-extra-large"), H = a.data("r-extra-large-nav"),
            P = a.data("r-extra-large-dots"), D = a.data("center"), M = a.data("custom-nav") || "";
        a.owlCarousel({
            loop           : !!t,
            items          : n || 4,
            lazyLoad       : !0,
        ...
        if (M) {
            d = e(M);
            var O = e(".rt-next", d), z = e(".rt-prev", d);
        ...
        n.length && n.magnificPopup({
            ...
            preloader      : !1,
            fixedContentPos: !1
        }), e(".popup-zoom-single").length && e(".popup-zoom-single").magnificPopup({type: "image"}), e(".zoom-gallery").length && e(".zoom-gallery").each(function () {
            e(this).magnificPopup({delegate: "a.popup-zoom", type: "image", gallery: {enabled: !0}})
        });
        var o = e("#no-equal-gallery");
        if (o.length) var i = o.imagesLoaded(function () {
            i.isotope({itemSelector: ".no-equal-item", masonry: {columnWidth: ".no-equal-item"}})
        });
        ...
        s -= 50, e(".mean-nav > ul").css("height", s + "px"), o(), t = 0, n = 0, i = e(window).width(), e(".equal-height-wrap .item-img,.equal-height-wrap .item-content").height("auto"), i > 991 && (e(".equal-height-wrap").each(function () {
            var a = e(this), o = a.find(".item-img").height();
            t = o > t ? o : t;
        ...
        var a = e("#sticker"), t = e("body"), n = a.outerHeight(), o = e(window).scrollTop(), i = e(window).width(),
            s = a.parent("#header-two"), r = a.parent("#header-one"),
