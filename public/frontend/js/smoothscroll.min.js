!function () {
    function e() {
        if (!C && document.body) {
            C = !0;
            var e = document.body, t = document.documentElement, o = window.innerHeight, a = e.scrollHeight;
            if (z = document.compatMode.indexOf("CSS") >= 0 ? t : e, v = e, M.keyboardSupport && s("keydown", n), top != self) E = !0; else if (a > o && (e.offsetHeight <= o || t.offsetHeight <= o)) {
    ...
    function t(e, t, o) {
        ...
        var r, i;
        if (A.push({x: t, y: o, lastX: 0 > t ? .99 : -.99, lastY: 0 > o ? .99 : -.99, start: Date.now()}), !B) {
            var l = e === document.body, c = function (n) {
    ...
    function n(e) {
        var o = e.target, n = e.ctrlKey || e.altKey || e.metaKey || e.shiftKey && e.keyCode !== Y.spacebar;
        ...
        var i = 0, c = 0, u = l(v), d = u.clientHeight;
    ...
    function l(e) {
        var t = [], o = document.body, n = z.scrollHeight;
        do {
            var a = K[O(e)];
            if (a) return i(t, a);
    ...
    var v, g, y, S, x, k, D = {
            ...
            fixedBackground: !0,
            excluded: ""
        }, M = D, T = !1, E = !1, H = {x: 0, y: 0}, C = !1, z = document.documentElement, L = [],
        X = /^Mac/.test(navigator.platform), Y = {
            left: 37,
            up: 38,
            right: 39,
            down: 40,
            ...
            home: 36
        }, A = [], B = !1, N = Date.now(), O = (k = 0, function (e) {
    ...
    var q, P,
        R = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || function (e, t, o) {
            ...
            return P
        }, I = window.navigator.userAgent, _ = /Edge/.test(I), V = /chrome/i.test(I) && !_, W = /safari/i.test(I) && !_,
        $ = /mobile/i.test(I), U = /Windows NT 6.1/i.test(I) && /rv:11/i.test(I), G = (V || W || U) && !$;
